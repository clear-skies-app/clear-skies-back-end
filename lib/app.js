...
const { mungeApod, mungeLocation } = require('./api-utils.js');
...
app.get('/apod', async(req, res) => {
  try {
    const data = await request.get(`https://api.nasa.gov/planetary/apod?count=10&api_key=${process.env.NASA_API_KEY}`);
...
app.post('/api/observations', async(req, res) => {
  ...
  try {
    ...
    VALUES ($1, $2, $3, $4, $5)
    RETURNING *
    `, [req.body.name, req.body.image, req.body.notes, req.body.observed, req.userId]);
